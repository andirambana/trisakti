...
import styled from "./visimtu.css";
export default function Visimtu() {
  return (
    <div>
      <section id="visi-mtu">
        <div className="container">
          <div className="row text-center">
            ...
            <h2 className="visi-h2">Manajemen Transportasi Udara</h2>
          </div>
          <div className="row">
            <div className="col-lg-8 mx-auto">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  membagun ahli madya dibidang Manajemen Transportasi Udara yang
                  bereputasi global.
                </div>
              </div>
              <div className="card">
