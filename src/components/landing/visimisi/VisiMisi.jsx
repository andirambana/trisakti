					...
					<div className="row">
						<div className="col-md-4 me-auto">
							<div className="card shadow">
								...
								<div className="card-title1">Yulianti Keke, SE, M.Si</div>
								<div className="card-title2">
									Direktur Vokasi
									<br />
									Institut Transportasi dan Logistik Trisakti <br />
									<br />
								</div>
								<div className="card-text">
									...
									<br />
									Puji Syukur pada Tuhan Yang Maha Esa, pada 7 Februari 2018,
									STMT Trisakti berubah menjadi Institut Transportasi dan
									Logistik Trisakti (ITL Trisakti) melalui Surat Keputusan
									Menteri Riset, Teknologi dan Pendidikan Tinggi Republik
									Indoensia Nomor : 176/KPT/I/2018 tentang Izin Perubahan Bentuk
									Sekolah Tinggi Manajemen Transportasi Trisakti di Jakarta
									menjadi Institut Transportasi dan Logistik Trisakti di Jakarta
									yang diselenggarakan oleh Yayasan Trisakti,{" "}
								...
								<div className="card-body">
									<ol type="1">
										...
										<li>
											...
											dalam bidang manajemen transportasi laut, manajemen
