								...
								<div className="card-body">
									<div className="row">
										...
										<p className="mt-3 ps-5 pe-5" mt-5>
											...
											akan menjadi sasaran yang ingin dicapai dengan kemampuan
											...
											<ol type="1">
												<li>
													...
													dan Respon dan Tindakan yang cepat : (1st Triple
													'Leadership" - Good wilingness Strong Commitment, and
												...
												<li>
													...
													Kreatif, Inovatif dan Produktif : (3nd Triple
